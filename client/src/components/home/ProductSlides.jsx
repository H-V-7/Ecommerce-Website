...
export default function ProductSlide({products, title}){
    ...
    return(
        <Box sx={{marginTop:10,backgroundColor:"white"}}>
            ...
            <Divider  />
            <Box>   
                <Carousel infinite={true}   centerMode={true} keyBoardControl={true} swipeable={false} responsive={responsive} otListClass="custom-dot-list-style"
